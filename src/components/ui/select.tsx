...
import { Root, Group, Value, Trigger, Icon, Content, Portal, Viewport, Label, Item, ItemIndicator, ItemText, Separator, ScrollUpButton, ScrollDownButton } from "@radix-ui/react-select"
